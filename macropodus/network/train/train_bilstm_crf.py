...
def train_w2v(hyper_parameters=None, rate=1.0):
    if not hyper_parameters:
        hyper_parameters = {
            ...
            'embed_size': 16,  # 768,  # 字/词向量维度, bert取768, word取300, char可以更小些
            'vocab_size': 20000,  # 这里随便填的，会根据代码里修改
            'trainable': True,  # embedding是静态的还是动态的, 即控制可不可以微调
            'level_type': 'char',  # 级别, 最小单元, 字/词, 填 'char' or 'word', 注意:word2vec模式下训练语料要首先切好
            'embedding_type': 'word2vec',  # 级别, 嵌入类型, 还可以填'random'、 'bert'、 'albert' or 'word2vec"
            'model': {'label': 91,  # 类别数
                      ...
                      'rnn_units': 16,  # rnn隐藏元, 128, 256, 512, 768, 1024等
            ...
            'data': {'train_data': path_tag_people_1998_train, # path_seg_pku_1998_train, # path_ner_people_1998_train, # path_tag_people_2014_train, # path_seg_pku_1998_train,  # path_ner_people_1998_train, # 训练数据
                     'val_data': path_tag_people_1998_train # path_seg_pku_1998_train # path_ner_people_1998_valid # path_tag_people_2014_valid # path_seg_pku_1998_train  # path_ner_people_1998_valid    # 验证数据
                     },
        }
    ...
    if not hyper_parameters:
        hyper_parameters = {
            ...
            'model': {'label': 12,  # 类别数
                      ...
                      'decay_rate': 0.99,  # 学习率衰减系数, 乘法, 最好是0.95以上吧
            ...
            'data': {'train_data': path_ner_people_1998_train, # path_tag_people_2014_train, # path_seg_pku_1998_train,  # path_ner_people_1998_train,  # path_seg_pku_1998_train,  # path_ner_people_1998_train, # 训练数据
                     'val_data': path_ner_people_1998_valid # path_tag_people_2014_valid # path_seg_pku_1998_train  #  path_ner_people_1998_valid # path_seg_pku_1998_train  # path_ner_people_1998_valid    # 验证数据
                     },
        }
